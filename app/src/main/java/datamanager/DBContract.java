...
//    Define the possible paths for accessing data in this contract
    ...
    static final String PATH_MOTHER = "mother";
...
//        variable that will store the URI used by the Content Provider to get memories from this table
        ...
        //        variable that will store the URI used by the Content Provider to get memories from this table
        public static final Uri GET_MOTHER_MEMORY_URI =
                BASE_CONTENT_URI.buildUpon().appendPath(PATH_MEMORY).appendPath(PATH_GET).appendPath(PATH_MOTHER).build();
...
//        inner final IV that holds the actual memory ID of the parent memory
        public static final String COL_PARENT_MEMORY_ID = "PARENT_ID";
